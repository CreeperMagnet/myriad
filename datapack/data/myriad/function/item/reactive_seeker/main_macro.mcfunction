...
$loot replace entity @s $(slot) loot myriad:technical/map/reactive_seeker
...
data merge storage myriad:temp {root:{item:{id:"minecraft:poisonous_potato",count:1,components:{"minecraft:lodestone_tracker":{target:{pos:[0,7,0],dimension:"minecraft:the_nether"},tracked:0b},"!minecraft:consumable":{}}}}}
