...
data modify storage myriad:temp root.item.components."minecraft:lore" prepend value {"color":"blue","italic":false,"translate":"potion.withDuration","with":[{"translate":"potion.withAmplifier","with":[{"translate":"effect.minecraft.strength"},{"translate":"potion.potency.4"}]},{"translate":"potion.myriad.duration","with":["0","0","0","2"]}]}
data modify storage myriad:temp root.item.components."minecraft:lore" prepend value {"color":"red","italic":false,"translate":"potion.withDuration","with":[{"translate":"effect.minecraft.blindness"},{"translate":"potion.myriad.duration","with":["0","0","0","2"]}]}
