...
data modify storage myriad:temp root.item.components."minecraft:custom_data".myriad.potion.uses set value [4,4]
data modify storage myriad:temp root.item.components."minecraft:lore"[1] set value {"translate":"item.myriad.diluted_potion.uses","color":"gray","italic":false,"with":["4","4"]}
data modify storage myriad:temp root.item.components."minecraft:custom_model_data".floats[0] set value 4.0f
